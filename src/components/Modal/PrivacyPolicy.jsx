...
export const PrivacyPolicy = () => {
  return (
    <section className={styles.rules}>
          <div className='container'><h1>Privacy Policy</h1>
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Trust Breaking.</p>
        </li>
        <li>
    ...
    <ul>
        <li>
            ...
            <p>Mouseflow is a session replay and heatmap tool that shows how visitors click, move, scroll, browse, and
                pay attention on websites. The service is operated by ApS.</p>
            <p>Mouseflow service may collect information from Your device.</p>
            <p>The information gathered by Mouseflow is held in accordance with its Privacy Policy: <a
                    href="https://mouseflow.com/privacy/" 
                    target="_blank" rel="noreferrer">https://mouseflow.com/privacy/</a></p>
        </li>
    </ul>
    ...
    <ul>
        <li>By visiting this page on our website: <a href="https://www.trustbreaking.com/"
                 target="_blank" rel="noreferrer">https://www.trustbreaking.com/</a></li>
    </ul></div>
    </section>
  )
}
