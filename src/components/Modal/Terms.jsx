...
<section className={styles.rules}>
    <div className='container'>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Trust Breaking.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Trust Breaking, accessible from <a
                        href="https://www.trustbreaking.com" 
                        target="_blank" rel="noreferrer">https://www.trustbreaking.com</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: support@trustbreaking.com</li>
        </ul>
    </div>
</section>
)
